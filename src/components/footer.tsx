        ...
        <div className="w-full border-t border-primary-foreground bg-background text-muted md:fixed bottom-0 z-[100000]">
            <div className="flex flex-col-reverse p-6 gap-7 md:flex-row h-full items-center container justify-between">
                <div className="flex flex-col md:flex-row items-center gap-3 md:gap-8 font-medium text-xl">
                    <a
                        href="https://www.termsfeed.com/live/d619dcf5-694a-4c99-9881-8eb825a581bd"
                        target="_blank"
                    ...
                    <a
                        href="https://docs.google.com/document/d/1D6FRBPa2N2wzt4KxcYH7kpILxByt__MNTSj6FuCdGnI/edit?usp=sharing"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        Terms & Conditions
                ...
                <div className="flex items-center gap-4">
                    <a
                        href="https://www.linkedin.com/company/vtion-media/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                    ...
                    <a
                        href="https://www.instagram.com/vtiondigital/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
